...
#This scrips searches through a phytab file (tab delimited) for duplicate sequences
#It only compares species name and unique geneIDs, it does not compare actual sequences
#Options are to keep the longest of duplicated sequences
#ignore-gaps option (=1) will not count "-" in sequence length for comparison
#Usage: perl remove_phytab_dupes.pl <infile-phytab> <1=keeplongest|0> <1=ignoregaps|0> <filename for unique seqs><filename for duplicated>
